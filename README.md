This repository contains code I developed in the MDPAgent.py file, where I developed a machine learning agent to play the Pacman game using Markov Decision Process (MDP) algorithms.
